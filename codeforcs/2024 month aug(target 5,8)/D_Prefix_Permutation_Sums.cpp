//*______________________________________________ D_Prefix_Permutation_Sums || 1300 __________________________________________________
/*
                                                                                                                                                                       //|
                                                                                                                                                                       //|
*/
...
void logic()
{
    ...
    FOR(i, 1, n - 1)
    {
        ...
        if (s.find(v[i] - v[i - 1]) != s.end() || v[i] - v[i - 1] > n)
        {
