//*______________________________________________ A_Doremy_s_Paint_3 || 800 __________________________________________________
/*
                                                                                                                                                                       //|
                                                                                                                                                                       //|
*/
...
void logic()
{
    ...
    if (mp.size() == 2)
    {
        if (n % 2 == 0 && k.second - l.second == 0)
        {
            COUT("YES");
            return;
        }
        if (n % 2 != 0 && abs(k.second - l.second) == 1)
        {
            COUT("YES");
            return;
        }
