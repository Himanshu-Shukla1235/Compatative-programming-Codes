//*______________________________________________ C_Grouping_Increases || 1400 __________________________________________________
/*
                                                                                                                                                                       //|
                                                                                                                                                                       //|
*/
...
void logic()
{
    ...
    FOR(i, 0, n)
    {
        ...
        else if (v1.back() > v[i] && v2.back() > v[i])
        {
            if (v1.back() <= v2.back())
            {
                v1.push_back(v[i]);
