//*______________________________________________ 1000 || B_K_Sort __________________________________________________
/*
                                                                                                                                                                       //|
                                                                                                                                                                       //|
*/
...
void logic()
{
    ...
    ll count = countmap.size()-1;
    ll summition = 0;
    AUTO_IT(countmap)
    {

        sum = sum + (count  + val.second+1) * abs(val.first-summition) ;
        count--;
        summition = val.first;
    }
    // Print the map
