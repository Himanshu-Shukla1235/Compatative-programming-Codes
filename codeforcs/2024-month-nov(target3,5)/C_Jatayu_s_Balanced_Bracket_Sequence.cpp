//*______________________________________________ 1300 || Hatyus Balanced Bracket Sequeence __________________________________________________
/*
                                                                                                                                                                       //|
                                                                                                                                                                       //|
>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>__           __<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
...
int checkIfbala(vector<ll> v, ll x, ll y)
{
    ll n = abs(x - y) + 1;
    if (n % 2 != 0)
    {
