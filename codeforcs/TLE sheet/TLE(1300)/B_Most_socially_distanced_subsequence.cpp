//*______________________________________________ B_Most_socially_distanced_subsequence || 1300 __________________________________________________
/*
                                                                                                                                                                       //|
                                                                                                                                                                       //|
*/
...
void logic()
{
    ...
    if (n > 0)
    {
        ...
        // Iterate over the vector to find local maxima and minima
        for (ll i = 1; i < n; ++i)
        {
            // If we are at the first or last element, handle separately
            if (i == n - 1 || i == 0)
            {
                re.insert(v[i]);
                continue;
        ...
        // Output the values in the original order
        AUTO_IT(v)
        {
            if (re.find(val) != re.end())
            {
                cout << val << " ";
            }
        }
        COUT(""); // Add a newline for proper formatting
    }
}
