//*______________________________________________ Average Sleep Time || 1300 __________________________________________________
/*
                                                                                                                                                                       //|
                                                                                                                                                                       //|
*/
...
void logic()
{
    ...
    if (n == 1)
    {
        ...
        cout << fixed << setprecision(10) << v[0] / double(n - k + 1) << endl;
        return;
    }
    ...
    // Compute the average of the results in re
    double result = accumulate(re.begin(), re.end(), 0.0) / double(re.size());
...
// Concept of efficient sol. : use the sliding window concept and also htis questin teach you to deal with the decimal problems ;   ......

// concpt used by me : jsut simple mathematics logic i used here ...

// suggestion : try using data structure ............

// Something New : sliding window concept although it is not kind of new deffrent but ya it is standered to solve problem like this !