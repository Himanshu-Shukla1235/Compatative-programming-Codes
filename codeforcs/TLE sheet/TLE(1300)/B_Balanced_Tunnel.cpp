//*______________________________________________ Blanced Tunnel || 1300 __________________________________________________
/*
                                                                                                                                                                       //|
                                                                                                                                                                       //|
*/
...
void logic() {
    ...
    // Read values into vector v
    AUTO_IT(v) {
        cin >> val;
    }

    // Read values into vector v1 and push them into the queue
    AUTO_IT(v1) {
        cin >> val;
        q.push(val);
    }

    // Process the queue to match the vector v
    FOR(i, 0, n) {
        // Skip if value is already processed
        if (s.find(v[i]) != s.end()) {
            continue;
        }
        
        // Remove elements from the queue until we find v[i]
...
// Concept : normal queue is used in problem   ......

// suggestion : try to think some dsa if used in problem  ............
