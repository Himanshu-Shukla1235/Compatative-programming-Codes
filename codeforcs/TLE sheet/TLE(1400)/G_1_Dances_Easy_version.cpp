//*______________________________________________ 1400 || Dances(Easy verrsion) __________________________________________________
/*
                                                                                                                                                                       //|
                                                                                                                                                                       //|
*/
...
void logic()
{
    ...
    COUT(result); // Print final result
}
