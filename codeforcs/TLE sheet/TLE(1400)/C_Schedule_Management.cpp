//*______________________________________________ 1400 || Schedule Management  __________________________________________________
/*
                                                                                                                                                                       //|
                                                                                                                                                                       //|
>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>__           __<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
...
void logic()
{
    ...
    FOR(i, m)
    {
        ...
        FOR(i, mp.size())
        {
            if (mp[i + 1] > 0)
            {
                temp3 = max(mp[i + 1], temp3);
                if (temp4 == 0)
                {
                    mp[i + 1] -= min(temp1, mp[i + 1]);
                }
                else
                {
                    mp[i + 1] -= 3;
