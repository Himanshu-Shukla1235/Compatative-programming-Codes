...
void logic2()
{
    ...
    {
        ll mid = l + (r - l) / 2;
        ll row = ceil(double(sum) / double(x));
...
// Concept of efficient sol. : 🧑🏿‍💻 we can solve question by just observing the  necessory and the sufficient conditions v  ......

// concpt used by me : i am not able to think any  good logic;

// suggestion :this is new type of question because in this we have to think abount the condition and observe the sol . so try to do  this type of question also your binary is weak do it
