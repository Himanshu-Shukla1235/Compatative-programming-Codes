...
// custom comparator 1
bool sortPairsByMin(pair<long long, long long> a, pair<long long, long long> b)
{
...
// void sortPairsByMin(vector<pair<long long, long long>> &v)
// {
//     sort(v.begin(), v.end(), [](pair<long long, long long> a, pair<long long, long long> b)
//          { return min(a.first, a.second) < min(b.first, b.second); });
// }
// void sortPairsByMax(vector<pair<long long, long long>> &v)
// {
//     sort(v.begin(), v.end(), [](pair<long long, long long> a, pair<long long, long long> b)
//          { return max(a.first, a.second) < max(b.first, b.second); });
// }
...
void logic()
{
    ...
    sort(v.begin(), v.end(), sortPairsByMin);
    AUTO_IT(v)
    {
...
// Concept of efficient sol. : jwhat i did  ......

// concpt used by me : jjust to use the constructor and simple logic of the sorting .

// suggestion : try to use the constructors

// Something New :yes the use of the constructor and the sorting logic