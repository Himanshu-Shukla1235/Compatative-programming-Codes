//*______________________________________________ WOW Factor || 1300 __________________________________________________
/*
                                                                                                                                                                       //|
                                                                                                                                                                       //|
*/
...
void logic()
{
    ...
    ll count = 0, numpairs = 0,result=0;
    ...
    FOR(i, s.length())
    {
        if (s[i] == 'o')
        {
            ...
            {
                numpairs += count - 1;
                p.push_back(make_pair(numpairs, 0));
                count = 0;
            }
            else
            {
