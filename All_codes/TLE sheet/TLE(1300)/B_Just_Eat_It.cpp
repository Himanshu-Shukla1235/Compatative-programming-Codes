//*______________________________________________ Just Eat it ! || 1300 __________________________________________________
/*
                                                                                                                                                                       //|
                                                                                                                                                                       //|
*/
...
void logic()
{
    ...
    vector<ll> v1(v.begin() + 1, v.end());
    vector<ll> v2(v.begin(), v.end() - 1);
    ll sum2 = max(maxSumSubarray(v1), maxSumSubarray(v2));
    // cout << sum1 << " " << sum2 << " ";
