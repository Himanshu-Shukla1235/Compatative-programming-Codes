...
public:
    ...
    int order_of_key(ll value)
    {
        return distance(data.begin(), data.lower_bound(value)); // Return number of elements < value
    }
...
void logic()
{
    ...
    {
        ans += v2.size() - v2.order_of_key(p.second); // Count elements > p.second
        v2.insert(p.second);
    }
...
// failure: yes failure    -- the time complexity faliure  ....

// Concept of efficient sol. : here we use the main concept have order of the key on set which is efficiently used to get the index of the num ;   ......

// concpt used by me : the same concept used in different way by using the upper and the lower bound but it is unsuccesfull because o the time complexity problem ;

// suggestion : its just new thing grasp it ............
