//*______________________________________________ 1400 || Make it Round __________________________________________________
/*
                                                                                                                                                                       //|
                                                                                                                                                                       //|
>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>__           __<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
...
void logic()
{
    ...
    ll tempb = b;
    ll fact, untill = abs(coun2 - coun5);
    if (coun2 > coun5)
    {
        fact = 5;
    }
...
// Concept of efficient sol. : use concep 5 *2 = 10   ......
