...
ll maximdiff(vector<ll> &v, ll num)
{
    ll maxmm = LLONG_MIN;
    sort(v.begin(), v.end());
...
// my soll is bruit force  - this is also write as acc to question we van solve in n^2   time complexity .
void logic()
{
    ll n;
    cin >> n;
