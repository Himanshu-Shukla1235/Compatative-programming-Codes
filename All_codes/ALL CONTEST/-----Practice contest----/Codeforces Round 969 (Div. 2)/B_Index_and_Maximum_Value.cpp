//*______________________________________________ B || Index and Maximum Value  __________________________________________________
/*
                                                                                                                                                                       //|
                                                                                                                                                                       //|
*/
...
void logic()
{
    ...
    vector<pair<char, pair<int, int>>> p(n);
